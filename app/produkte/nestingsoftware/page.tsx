...
export default function Nesting() {
  ...
  const text3 = ["Die Entfernung der doppelten Schneidlinien führt zu weiterer Ersparnis, vor allem bei der zum Ausschneiden benötigten Zeit. Im Beispiel 3A kommt das Schrumpfen & Clipping hinzu."]
