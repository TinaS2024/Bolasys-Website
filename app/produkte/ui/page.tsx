  ...
  const text2 = ["Landingpages mit dem neuen React-Java-Script-Framework Next."];
    ...
    return (
      ...
      <Background top="-350px" left="0px" opacity="10%"></Background>
          ...
          <div id="magento" className="relative flex flex-col items-center mb-8"><DesignerTooltip top="4%" left="4%" titel="Magento" beschreibung={text1} bildpfad={leerbild}/><Image src={magento_bild} alt="magento" width={200} height={200}></Image></div>
          <p>{text1}</p>
          <div id="next" className="relative flex flex-col items-center"><DesignerTooltip top="5%" left="-5%" titel="Next JS" beschreibung={text2} bildpfad={leerbild}/><Image src={next_bild} alt="next-js" width={200} height={200}></Image></div>
          <p>{text2}</p>
    </>
    );
  }
